...
export class WatchlistService {
  ...
  getWatchlists() {
    this.http.get<IWatchlist[]>('http://pyramidmovieclub-env.eba-2f3jnpr3.us-east-1.elasticbeanstalk.com/api/watchlist').subscribe(watchlists => {
  ...
  toggleBookmark(movieId: number) {
    ...
    this.http.post<IWatchlist>(`http://pyramidmovieclub-env.eba-2f3jnpr3.us-east-1.elasticbeanstalk.com/api/watchlist/${watchlistId}/${movieId}/bookmark`, {}).subscribe((watchlistResponse) => {
  ...
  createWatchlist(watchlist: { name: string, by: string, 'private': boolean }) {
    this.http.post<IWatchlist>('http://pyramidmovieclub-env.eba-2f3jnpr3.us-east-1.elasticbeanstalk.com/api/watchlist', watchlist).subscribe((watchlistCreated) => {
  ...
  deleteWatchlist() {
    ...
    this.http.delete<IWatchlist>(`http://pyramidmovieclub-env.eba-2f3jnpr3.us-east-1.elasticbeanstalk.com/api/watchlist/${watchlistId}`).subscribe((deletedWatchlist) => {
